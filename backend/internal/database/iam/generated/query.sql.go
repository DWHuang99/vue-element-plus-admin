...
func (q *Queries) CreateExternalUser(ctx context.Context, arg CreateExternalUserParams) (UserExternalIdentity, error) {
	row := q.db.QueryRowContext(ctx, createExternalUser,
		arg.UserID,
		arg.ProviderIssuer,
		arg.ProviderSubject,
		arg.Email,
...
const findExternalUser = `-- name: FindExternalUser :one
...
type FindExternalUserParams struct {
	ProviderIssuer  string `json:"provider_issuer"`
	ProviderSubject string `json:"provider_subject"`
}

func (q *Queries) FindExternalUser(ctx context.Context, arg FindExternalUserParams) (UserExternalIdentity, error) {
	row := q.db.QueryRowContext(ctx, findExternalUser, arg.ProviderIssuer, arg.ProviderSubject)
	var i UserExternalIdentity
	err := row.Scan(
		&i.ID,
		&i.UserID,
