...
func (q *Queries) ListUserRolesByUserIDs(ctx context.Context, dollar_1 []int64) ([]ListUserRolesByUserIDsRow, error) {
	rows, err := q.db.Query(ctx, listUserRolesByUserIDs, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
