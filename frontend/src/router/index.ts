  ...
  ...([
    {
      path: '/function/test',
      redirect: (to) => ({
        path: '/demo/authorization/permission',
        query: to.query,
        hash: to.hash
      }),
      meta: {
    ...
    },
    {
      ...
      redirect: (to) => ({
        path: to.path.replace(/^\/dashboard(?=\/|$)/, '/demo/dashboard'),
        query: to.query,
        hash: to.hash
      }),
      meta: {
    ...
    {
      path: '/guide/:pathMatch(.*)*',
      redirect: (to) => ({
        path: to.path.replace(/^\/guide(?=\/|$)/, '/demo/guide'),
        query: to.query,
        hash: to.hash
      }),
      meta: {
    ...
    },
    {
      ...
      redirect: (to) => ({
        path: to.path.replace(/^\/components(?=\/|$)/, '/demo/components'),
        query: to.query,
        hash: to.hash
      }),
      meta: {
    ...
    {
      path: '/function/:pathMatch(.*)*',
      redirect: (to) => ({
        path: to.path.replace(/^\/function(?=\/|$)/, '/demo/function'),
        query: to.query,
        hash: to.hash
      }),
      meta: {
    ...
    {
      path: '/hooks/:pathMatch(.*)*',
      redirect: (to) => ({
        path: to.path.replace(/^\/hooks(?=\/|$)/, '/demo/hooks'),
        query: to.query,
        hash: to.hash
      }),
      meta: {
    ...
    {
      path: '/level/:pathMatch(.*)*',
      redirect: (to) => ({
        path: to.path.replace(/^\/level(?=\/|$)/, '/demo/level'),
        query: to.query,
        hash: to.hash
      }),
      meta: {
    ...
    {
      path: '/example/:pathMatch(.*)*',
      redirect: (to) => ({
        path: to.path.replace(/^\/example(?=\/|$)/, '/demo/example'),
        query: to.query,
        hash: to.hash
      }),
      meta: {
    ...
    },
    {
      ...
      redirect: (to) => ({
        path: to.path.replace(/^\/error(?=\/|$)/, '/demo/error'),
        query: to.query,
        hash: to.hash
      }),
      meta: {
        ...
        children: [
          {
            path: 'form',
            component: getParentLayout(),
            redirect: '/demo/components/form/default-form',
            name: 'Form',
            meta: {
              title: 'router.form',
              alwaysShow: true
